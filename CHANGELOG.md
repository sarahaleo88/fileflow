...
### Changed
- **Architecture**: Switched from `mattn/go-sqlite3` (CGO) to `modernc.org/sqlite` (Pure Go).
  - Removes CGO requirement for building.
  - Enables easy static linking and cross-compilation for all platforms.
  - Resolves build failures for ARM64 and Windows targets.

## [1.0.2] - 2026-01-14

### Added
- **Binaries**: Automated cross-platform binary generation (Linux, macOS, Windows) and checksums via GoReleaser.
